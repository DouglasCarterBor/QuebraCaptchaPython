...
def quebrar_captcha():
    # 01 - IMPORTAR O MODELO QUE FOI TREINADO E O TRADUTOR
    with open("rotulo_modelo.dat", "rb") as arquivo_tradutor:
        lb = pickle.load(arquivo_tradutor)

    modelo = load_model("modelo_treinado.hdf5")

    # 02 - USAR O MODELO PARA RESOLVER OS CAPTCHAS
    # 02.01 - LER TODOS OS ARQUIVOS DA PASTA RESOLVER
    # 02.02 - PARA CADA ARQUIVO, TRATAR A IMAGEM
    tratar_imagens("resolver", pasta_destino="resolver")
    # 02.03 - IDENTIFICAR AS LETRAS
    ...
    for arquivo in arquivos:
        ...
        for retangulo in regiao_letras:
            ...
            #DAR A LETRA PARA A IA DESCOBRIR
            imagem_letra = resize_to_fit(imagem_letra, 20, 20)

            #ADICIONAR MAIS DUAS DIMENSÕES
    ...
    # 02.04 - PEGAR AS LETRAS E DAR PARA A IA
    # 02.05 - JUNTAR AS LETRAS EM UM TEXTO SÓ
